...
def train_model_on_stage(stage,model,fast_start=False,split=True,fine_tune=False):
	...
	for epoch in range(15, nb_epoch):
...
if __name__ == '__main__':
	...
	#model_64 = load_model("model_des_v37d_64_12.h5")
	model_64_pt = load_model('model_des_v37d_64_24.h5')
	model_64_pt.save_weights('temp_weights.h5')
	model_64.load_weights('temp_weights.h5',by_name=True)
