...
def train_model_on_stage(stage,model,fast_start=False,split=True,fine_tune=False):
	...
	name = 'model_des_v37f_' + str(stage) + '_{epoch:02d}.h5'
	...
	if fine_tune:
		...
		name = 'model_des_v37f_' + str(stage) + '_finetune_{epoch:02d}.h5'
		chkp = ModelCheckpoint(filepath=name)
...
if __name__ == '__main__':
	...
	# model_64 = load_model("F:\Flung\descriptor models\model_des_v37f_64_08.h5")
	# model_96 = build_model((1,96,96,96))
	 # model_256 = build_model((1,256,256,256))
	
	model_32.summary()
	
	# model_32.load_weights('model_v37f_describer_weights_temp.h5')
	...
	model_32.save_weights('model_v37f_describer_weights_temp.h5')
	model_64.load_weights('model_v37f_describer_weights_temp.h5')
	model_64 = train_model_on_stage(64, model_64,fast_start=False,split=True,fine_tune=True)
	model_64.save_weights('model_v37f_describer_weights_temp64.h5')
