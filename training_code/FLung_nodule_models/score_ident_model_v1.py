...
def load_and_txform_file(file,model,VOXEL_SIZE,batch_size,n_TTA=32):
	...
	xorig = np.load(os.path.join(r'F:\Flung\data_raw\data', file))
...
if __name__ == '__main__':
	...
	train_files = [f for f in os.listdir(r'E:\lung\data_raw\data') if '_testsg1' not in f]
	VOXEL_SIZE = int(sys.argv[2])
	model_batch_size=int(sys.argv[3])
	...
	for file in train_files:
		...
		print file, 'TODO: add tta', vox.shape[0], 'nodules', preds.max(), 'max score'
