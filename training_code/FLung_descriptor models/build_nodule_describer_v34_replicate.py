...
if __name__ == '__main__':
	...
	#v34_des_repl 64 model: 4.5 train loss and 4.27 valid loss @ 15
	
	#so clearly the v34_des_repl model isn't as good as the v24. 
	...
	#model_32.load_weights('model_v34_des_repl_weights_temp.h5')
	model_32 = train_model_on_stage(32, model_32,fast_start=False)
	# now save these weights and reload them in the next model
	model_32.save_weights('model_v34_des_repl_weights_temp.h5')
	model_64.load_weights('model_v34_des_repl_weights_temp.h5')
	model_64 = train_model_on_stage(64, model_64,fast_start=False)
	model_64.save_weights('model_v34_des_repl_weights_temp64.h5')
	# model_96.load_weights('model_v34_des_repl_weights_temp64.h5')
	# model_96 = train_model_on_stage(96, model_96)
	# model_96.save_weights('model_v34_des_repl_weights_temp96.h5')
	
	# model_128.load_weights('model_v34_des_repl_weights_temp64.h5')
	# model_128 = train_model_on_stage(128, model_128)
	# model_128.save_weights('model_v34_des_repl_weights_temp128.h5')
	
	# model_256.load_weights('model_v34_des_repl_weights_temp128.h5')
	# model_256 = train_model_on_stage(256, model_256)
	# model_256.save_weights('model_v34_des_repl_weights_temp256.h5')
